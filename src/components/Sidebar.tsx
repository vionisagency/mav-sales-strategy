    ...
    <aside className="fixed left-0 top-0 h-screen w-[220px] bg-navy-950 border-r border-navy-600 flex flex-col z-50">
      ...
      <div className="px-6 pt-8 pb-6 border-b border-navy-600">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-bold text-white leading-tight">Mav Consulting</p>
            <p className="text-[10px] text-slate-500 leading-tight">Sales Strategy</p>
          </div>
        </div>
      </div>

      {/* Nav */}
      <nav className="flex-1 px-3 py-6 space-y-1" aria-label="Presentation sections">
        <LayoutGroup>
            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-navy-950',
                  isActive
